      ...
      <CardContent>
        <Form {...form}>
          <div className="grid grid-cols-2 gap-x-12 gap-y-3 text-left">
                    ...
                    <p className="text-base text-gray-400 py-2">
                      {
                        dataCountries?.find(
                          (country) =>
                            country.code === dataUsers?.user?.nationality
                        )?.name
                      }
                    </p>
                  </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <p className="text-base text-gray-400 py-2">
                          {dataUsers?.student?.course_names}
                        </p>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
            ...
            <Link className="col-span-2" href='/profile'><Button className="w-full">Go to update profile</Button></Link>
          </div>
        </Form>
      </CardContent>
    </Card>
